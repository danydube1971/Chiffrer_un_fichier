"""Voici un script python3 pour Linux Mint qui utilise la bibliothèque PyCryptodome pour chiffrer un fichier avec AES 256 bits 
et demander un mot de passe à l'utilisateur. Vous avez besoin du module python3 cryptodome. Installez-le avec la commande pip3 install pycryptodome"""
